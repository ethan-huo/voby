...
import type { Observable, ObservableReadonly, JSX } from 'voby'
...
const ThreeScene = (
	...
	meshes: ObservableReadonly<Mesh[]>,
): HTMLCanvasElement => {
...
const Rotations = ({
	...
	rotations: ObservableReadonly<Rotation[]>
}): JSX.Element => {
	...
	return <div class="container">{scene}</div>
}
