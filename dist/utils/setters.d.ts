...
declare const setClassStatic: (element: HTMLElement, classes: string, force: null | undefined | boolean) => void;
...
declare const setRef: <T>(element: T, value: null | undefined | Ref<T> | (null | undefined | Ref<T>)[]) => void;
